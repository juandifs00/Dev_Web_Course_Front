...
export class Employee extends Component {
    ...
    changeEmployeetName = (e) => {
        this.setState({ EmployeetName: e.target.value });
    }
    ...
    editClick(emp) {
        this.setState({
            ...
            EmployeetId: emp.EmployeetId,
            EmployeetName: emp.EmployeeName,
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="modal fade" id="exampleModal" tabIndex="-1" arial-hidden="true"></div>
